...
# Saving the dataframe so that we don't have to unzip and load it as it takes time.

df.to_csv("E:\\TRENT\\SEM 4 Research Project\\ukraine_russia.csv",sep=',')
...
# Cleaning the tweets in the english langauge and filtering unique tweets
eng_clean = eng_df.apply(cleantext)
eng_u = list(dict.fromkeys(eng_clean))
...
eng_clean = pd.DataFrame(eng_u,columns=["text"])
...
eng_clean["compound"] = [sentiments.polarity_scores(i)["compound"] for i in eng_clean["text"]]
...
eng_clean["Analysis"] = eng_clean['compound'].apply(get_analysis)

result = eng_clean.Analysis.value_counts()


plt.title('Sentiment Analysis of English Tweets')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
eng_clean['Analysis'].value_counts().plot(kind='bar',color = ['red','green','blue'])
plt.show()
...
ru_eng_df["Positive"] = [sentiments.polarity_scores(i)["pos"] for i in ru_eng_df["text"]]
ru_eng_df["Negative"] = [sentiments.polarity_scores(i)["neg"] for i in ru_eng_df["text"]]
ru_eng_df["Neutral"] = [sentiments.polarity_scores(i)["neu"] for i in ru_eng_df["text"]]
ru_eng_df["compound"] = [sentiments.polarity_scores(i)["compound"] for i in ru_eng_df["text"]]



    
# Creating a new column which will contain the final sentiment of the tweets
ru_eng_df['Analysis'] = ru_eng_df["compound"].apply(get_analysis)

## show the distribution of sentiment with count
ru_eng_df['Analysis'].value_counts()

## plot visulatisation of count
plt.title('Sentiment Analysis of Russian text translated to English')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
ru_eng_df['Analysis'].value_counts().plot(kind='bar',color = ['red','blue','green'])
plt.show()
...
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
r_df.Analysis.value_counts().plot(kind='bar',color=['blue','red','green'])
...
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
r_df_scores['Analysis'].value_counts().plot(kind='bar',color=['blue','red','green'])
plt.show()
...
ru_bertdf.Analysis.value_counts().plot(kind = 'bar',color = ['red','green','blue'])
...
plt.subplot(2,3,1)
plt.title('SA English Tweets')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
eng_clean['Analysis'].value_counts().plot(kind='bar',color = ['red','green','blue'])

plt.subplot(2,3,3)
plt.title('SA Ru to En VADER')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
ru_eng_df['Analysis'].value_counts().plot(kind='bar',color = ['red','blue','green'])

plt.subplot(2,3,4)
plt.title('SA Ru text RUVADER')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
r_df_scores['Analysis'].value_counts().plot(kind='bar',color=['blue','red','green'])

plt.subplot(2,3,5)
plt.title('SA Ru Text Dostoevsky')
plt.xlabel('Sentiments') 
plt.ylabel('Counts')
r_df.Analysis.value_counts().plot(kind='bar',color=['blue','red','green'])
...
plt.subplot(2,3,2)
ru_bertdf.Analysis.value_counts().plot(kind = 'bar',color = ['red','green','blue'])
plt.title("SA Ru Text using RuBERT")
plt.tight_layout()
